                            ...
                            <table class="table table-hover table-striped">
                                ...
                                <?php foreach($_SESSION['cart'] as $id => $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" value="<?=$item['qty'] ?>" id="cart_qty_<?=$id ?>" name="cart_qty">
                                            <a href="/cart/recalculate/?id=<?=$id ?>" onclick="recalculateCart('<?=$id ?>');" class="btn btn-primary recalculate">recalculate</a>
                                        </td>
                                        <td><?=$item['price'] ?></td>
                                        <td>
